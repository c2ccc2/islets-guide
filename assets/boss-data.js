(function(){
  ...
  window.BOSS_DATA=[
    boss('grave-crawler','墓地爬行者','Grave Crawler','ground','诺斯特布尔（首座岛屿）','NorthStable Island (first island)','二段跳；推进首座岛屿流程','Double Jump and first-island progression','Root of Evil','https://presskits.armorgames.com/game/islets/images/Islets_Grass_Landing_Boss.png',['第一阶段会跳跃压向艾可，并召唤小怪；先清掉小怪，避免场面失控。','生命过半后会在中央召唤地刺。地刺不能靠翻滚穿过，要用跳跃越过。','保持中距离用弓箭磨血，等跳砸落地后的硬直再近身攻击。'],['Phase one uses crushing jumps and summoned minions; remove the minions first.','Below half health it summons spikes from the center. Jump over them instead of rolling through.','Use arrows at mid-range and take melee hits after a landing recovery.']),
    boss('sky-pirates','空中海盗','Sky Pirates','airship','天空之城空域；飞艇升级前可挑战','Sky City airspace, before airship upgrades','开放前往因弗尼斯的航线','Access to Inverness Island','Something’s fishy…','https://tryhardguides.com/wp-content/uploads/2022/08/islets-sky-pirate-1024x576.jpg'),
    ...
    boss('mecharat','机械鼠','MechaRat','airship','天空之城西北空域','Northwest of Sky City','开放前往沃夫派因的航线','Access to Wolfpine Island','A Sky Tail','https://videochums.com/review/islets-3.jpg'),
    boss('forgotten-grave','被遗忘的墓','Forgotten Grave','ground','雨原','Rainy Plains','开放一枚岛屿核心','Access to an islet core','Grave Danger'),
    boss('runaway-plant','失控植物','Runaway Plant','ground','空中花园','Hanging Gardens','位移箭','Shift Arrows','Tulip Tussle','https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/1669420/ss_cadcea7ed4e4c63f34da823489493283ec521145.jpg'),
